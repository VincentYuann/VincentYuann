...
* **Architectural Philosophy Bento**: 3 core tenets with kanji watermarks and design manifestos.
...
* **5 Dedicated Live Editors**:
  1. **Intro & Profile**: Headline, tagline, capability pillars ribbon, social links.
  2. **Experience**: Work history, roles, date ranges, bullets, and technology tags.
  3. **Projects**: Project cards, descriptions, architecture points, metrics, and tags.
  4. **Resume**: Live LaTeX source editor with Supabase database persistence.
  5. **Philosophy**: Kanji, Romaji, title, taglines, and core tenet descriptions.
